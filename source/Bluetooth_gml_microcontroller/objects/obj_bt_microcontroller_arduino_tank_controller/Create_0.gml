...
left = instance_create_depth(room_width/2-300,room_height/2,0,obj_bt_microcontroller_arduino_tank_wheel)
right = instance_create_depth(room_width/2+300,room_height/2,0,obj_bt_microcontroller_arduino_tank_wheel)
