# iOS post-project hook: code_gen source discovery, ObjCXX/Swift setup, includes, defines
...
if(EXTGEN_ENABLE_SWIFT)
  ...
  set_target_properties(${PROJECT_NAME} PROPERTIES
    ...
    XCODE_ATTRIBUTE_SWIFT_OBJC_BRIDGING_HEADER
      "${CMAKE_CURRENT_SOURCE_DIR}/code_gen/ios/${PROJECT_NAME}-Bridging-Header.h"
  )
endif()

if(EXT_APPLE_NATIVE_FRAMEWORK)
  message(STATUS "iOS flavour: NATIVE (ObjC wrapper + C++ native core)")
  target_sources(${PROJECT_NAME} PRIVATE ${SRC_CORE} ${SRC_COMMON} ${SRC_NATIVE} ${SRC_IOS})
  ...
  target_sources(${PROJECT_NAME} PRIVATE ${SRC_CORE} ${SRC_COMMON} ${SRC_IOS})
