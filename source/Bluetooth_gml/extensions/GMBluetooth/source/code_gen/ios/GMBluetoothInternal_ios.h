...
- (std::int32_t)bluetooth_pair:(std::uint64_t)device callback:(gm::wire::GMFunction)callback;
...
- (std::int32_t)bluetooth_le_server_add_service:(const gm_structs::BluetoothLeServiceDefinition&)service callback:(gm::wire::GMFunction)callback;
