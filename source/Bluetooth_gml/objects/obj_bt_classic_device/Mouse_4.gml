...
{
    var _connection = bluetooth_classic_connect(
        device,
    ...
    {
        show_debug_message(
            "[GML] classic connect failed to start: "
...
if (bluetooth_device_is_paired(device) || !bluetooth_pairing_is_supported(device))
{
    do_classic_connect();
}
else
