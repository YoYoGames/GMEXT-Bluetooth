...
function do_classic_connect() {
    var _connection = bluetooth_classic_connect(device, DEMO_CLASSIC_SERVICE_UUID,
    ...
    if (_connection == 0) {
        show_debug_message("[GML] classic connect failed to start: " + string(bluetooth_last_error_code()) + " " + bluetooth_last_error_message());
    }
}
